...
const FAMILY_COUNTS: Record<string, number> = { ADM: 4, VAL: 5, GRF: 5, EXE: 6, EXP: 5, SRC: 4, RCP: 6, STO: 5, CUS: 4, PRO: 7, CAP: 4, MBX: 5, APP: 10, MEM: 7, CTX: 3, RET: 3, EVO: 8, HST: 9, PKG: 5, CLD: 7 };
