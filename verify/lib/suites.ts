export const PLANNED_SUITES = [
  "toolchain-smoke",
  "differential", "fuzz-smoke", "evidence-mutation", "axioms", "lean-expr", "expr-conformance", "expr-abi",
