...
export const PROCESS_LIVE_SOURCES = ["src/process.ts", "src/process-journal.ts", "src/run.ts", "src/mailbox.ts", "src/errors.ts", "crates/algal/src/process.rs", "crates/algal/src/journal.rs", "crates/algal/src/runtime.rs", "crates/algal/src/mailbox.rs", "crates/algal/src/error.rs", "spec/v1/process.md", "spec/v1/process-journal.md", "src/process-recovery.test.ts", "crates/algal/tests/process.rs"];
