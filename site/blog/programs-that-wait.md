...
This is what "host-owned authority" means concretely: a program may sleep for a month, but it wakes up with *exactly* the powers it was given, with no ambient authority accumulated in the meantime, no handles minted out of data.
